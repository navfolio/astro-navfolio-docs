...
| `FriendLinkApplication` | 收集友链资料、复制标准 JSON，并生成预填的 GitHub Issue。   |
...
友链展示接口详见 [FriendLinkCard](/blog/friend-link-card/)，申请表单与 GitHub Issue 对接详见 [FriendLinkApplication](/blog/friend-link-application/)。若需要将友链 RSS 同步为静态文章数据，请使用 [Friend Circle Sync](/blog/friend-circle-sync/)。
